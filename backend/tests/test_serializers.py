...
from apps.authentication.serializers import RegisterSerializer, CustomTokenObtainPairSerializer
...
class TestSerializers:
    ...
    def test_register_serializer_password_mismatch(self):
        ...
        serializer = RegisterSerializer(data=data)
        assert not serializer.is_valid()
        assert 'password' in serializer.errors or 'password2' in serializer.errors or 'non_field_errors' in serializer.errors
