...
class TestTransactionViewsExtended:
    ...
    def test_transaction_update_status_endpoint(self, authenticated_client, transaction):
...
class TestCustomerViewsExtended:
    ...
    def test_customer_blacklist_filter(self, authenticated_client, blacklisted_customer):
