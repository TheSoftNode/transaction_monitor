...
class TestTransactionAPI:
    ...
    def test_retrieve_transaction(self, authenticated_client, transaction):
        ...
        assert response.status_code == status.HTTP_200_OK
        assert response.data['transaction_reference'] == transaction.transaction_reference
    ...
    def test_filter_transactions_by_customer(self, authenticated_client, transaction, customer):
    ...
    def test_search_transactions(self, authenticated_client, transaction):
        ...
        url = reverse('transactions:transaction-list')
        response = authenticated_client.get(url, {'search': transaction.transaction_reference})
